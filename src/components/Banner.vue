<template>
  <div class="w-full flex justify-center md:mt-14 lg:mt-10 xl:mt-14">
    ...
    >
      ...
      >
        <h1
          class="title sm:text-center md:text-left sm:leading-[45px] md:leading-[75px] md:text-[48px] xl:leading-[72px] sm:text-[28px] xl:text-5xl font-bold"
        >
          Jadi Bagian Ekosistem Kreator Audio
          <span class="bg-contain">Terbesar</span> di Indonesia
        </h1>
        <p
          class="md:text-[20px] xl:text-[20px] sm:text-center md:text-left sm:w-[600px] md:w-[300px] lg:w-[400px] xl:w-[550px] sm:mt-3 xl:mt-3"
        >
      ...
      <figure class="sm:mt-4 xl:w-[45%]">
        <img
          src="/noice-creator.svg"
          class="sm:w-[250px] lg:w-[340px] xl:w-[480px]"
